...
#---------------------------------------------------------------------------------
LIBS	:=      -lvorbisidec -logg -lmad -lasnd -logc -lgrrlib -lfreetype -lbz2 -lpngu -lpng -ljpeg -lz -lfat -lwiiuse -lbte -logc -lm 
...
makesd:
	...
	sudo mv $(OUTPUT).elf /media/sdcard
